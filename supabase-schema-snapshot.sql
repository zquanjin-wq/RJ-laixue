...
CREATE TABLE IF NOT EXISTS "public"."course_video_export_jobs" (
    ...
    "completed_at" timestamp with time zone,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "course_video_export_jobs_status_check" CHECK (("status" = ANY (ARRAY['uploading'::"text", 'queued'::"text", 'running'::"text", 'succeeded'::"text", 'failed'::"text", 'cancelled'::"text"])))
);


ALTER TABLE "public"."course_video_export_jobs" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."course_video_export_jobs"
    ADD CONSTRAINT "course_video_export_jobs_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "course_video_export_jobs_course_idx" ON "public"."course_video_export_jobs" USING "btree" ("course_id", "created_at" DESC);



CREATE INDEX "course_video_export_jobs_owner_idx" ON "public"."course_video_export_jobs" USING "btree" ("requested_by", "created_at" DESC);
...
ALTER TABLE ONLY "public"."course_video_export_jobs"
    ADD CONSTRAINT "course_video_export_jobs_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "public"."courses"("id") ON DELETE CASCADE;
...
CREATE POLICY "Owners can read their video export jobs" ON "public"."course_video_export_jobs" FOR SELECT USING ((("auth"."uid"())::"text" = "requested_by"));
...
GRANT ALL ON TABLE "public"."course_video_export_jobs" TO "anon";
GRANT ALL ON TABLE "public"."course_video_export_jobs" TO "authenticated";
GRANT ALL ON TABLE "public"."course_video_export_jobs" TO "service_role";
